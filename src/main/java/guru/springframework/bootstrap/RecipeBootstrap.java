...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
    	...
    	try {
    		...
    		System.err.println("RecipeBootstrap --> loadCategories");
    		e.printStackTrace();
    	}
    	try {
    		loadUom();
    	}catch(Exception e) {
    		System.err.println("RecipeBootstrap --> loadUom");
    		e.printStackTrace();
    	}
    	try {
    		...
    		System.err.println("RecipeBootstrap --> recipeRepository.saveAll(getRecipes())");
    		e.printStackTrace();
    	}
    		
    	log.info("########################");
    	log.info("########################");
    	log.info("unitOfMeasureReactiveRepository count: "+ unitOfMeasureReactiveRepository.count().block().toString());
    	log.info("recipeReactiveRepository count: "+ recipeReactiveRepository.count().block().toString());
    	log.info("categoryReactiveRepository count: "+ categoryReactiveRepository.count().block().toString());
